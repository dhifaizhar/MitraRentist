...
public class FormToysAsetActivity extends AppCompatActivity {
    ...
    private void contentcontrol() {
        ...
        if(iFormAsset.getStringExtra("action").equals("update")){
            ...
            ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.toys_subcategory_entries, android.R.layout.simple_spinner_item);
    ...
    private void addDataAset(String tenant) {
        ...
        showProgress(true);
        new FormToysAsetActivity.addAsetTask(tenant).execute();
    }
    ...
    private class addAsetTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConfig.URL_TOYS, new Response.Listener<String>() {
                @Override
        ...
        protected void onPostExecute(String aset) {
            ...
            if(aset != null){
                ...
                Toast.makeText(getApplicationContext(),"Data sukses disimpan", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(FormToysAsetActivity.this,AsetListActivity.class);
                intent.putExtra("asset_name", "Mainan Anak");
                intent.putExtra("asset_category", 6);
    ...
    private void updateDataAset(String category) {
        ...
        pDialog.setMessage("loading ...");
        showProgress(true);
        new FormToysAsetActivity.updateAsetTask(category).execute();
    }
