...
public class TransactionCancelAdapter extends RecyclerView.Adapter<TransactionCancelAdapter.ViewHolder> {
    private List<ItemTransaksiModul> mTransaksi;
    private Context context;
    private static final String TAG = "HistoryAdapter";

    public TransactionCancelAdapter(Context context, List<ItemTransaksiModul> mTransaksi){
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.transaction_cancel, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            ...
            thumb = (ImageView) itemView.findViewById(R.id.tr_can_thumb);
