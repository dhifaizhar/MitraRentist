...
public class FormOfficeAsetActivity extends AppCompatActivity {
    ...
    private void contentcontrol() {
        ...
        if(iFormAsset.getStringExtra("action").equals("update")){
            ...
            ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.office_subcategory_entries, android.R.layout.simple_spinner_item);
    ...
    private void addDataAset(String tenant) {
        ...
        showProgress(true);
        new FormOfficeAsetActivity.addAsetTask(tenant).execute();
    }
    ...
    private class addAsetTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConfig.URL_OFFICE, new Response.Listener<String>() {
                @Override
        ...
        protected void onPostExecute(String aset) {
            ...
            if(aset != null){
                ...
                Intent intent = new Intent(FormOfficeAsetActivity.this,AsetListActivity.class);
                intent.putExtra("asset_name", "Peralatan Kantor");
                intent.putExtra("asset_category", 11);
    ...
    private void updateDataAset(String category) {
        ...
        pDialog.setMessage("loading ...");
        showProgress(true);
        new FormOfficeAsetActivity.updateAsetTask(category).execute();
    }
    ...
    private class updateAsetTask extends AsyncTask<String, String, String> {
        ...
        @Override
        protected String doInBackground(String... params) {
            String URL = AppConfig.URL_OFFICE;
            RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
