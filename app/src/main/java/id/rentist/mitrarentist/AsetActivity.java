...
public class AsetActivity extends AppCompatActivity {
    ...
    private void getAssetCarDataList(String tenant) {
        pDialog.setMessage("loading asset car...");
        showProgress(true);
        new getAssetCarListTask(tenant).execute();
    }

    private void getAssetBikeDataList(String tenant) {
        pDialog.setMessage("loading asset bike...");
        showProgress(true);
        new getAssetBikeListTask(tenant).execute();
    }

    private void getAssetYachtDataList(String tenant) {
        pDialog.setMessage("loading asset yacht...");
        showProgress(true);
        new getAssetYachtListTask(tenant).execute();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_car) {
            ...
            getAssetBikeDataList(tenant);
        }else if(id == R.id.action_yacht){
            getAssetYachtDataList(tenant);
        }
    ...
    private class getAssetCarListTask extends AsyncTask<String, String, String> {
        ...
        private getAssetCarListTask(String tenant) {
            mTenant = tenant;
        }
